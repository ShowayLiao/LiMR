...
class MMR_(nn.Module):
    ...
    def forward_encoder(self, x, mask_ratio, ids_shuffle=None):# 前向编码器
        # embed patches
    ...
    def forward_decoder_FPN(self, x, ids_restore):
        ...
        return {layer: feature for layer, feature in zip(self.cfg.TRAIN.LiMR.layers_to_extract_from, results)}
