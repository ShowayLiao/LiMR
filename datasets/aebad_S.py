...
class AeBAD_SDataset(MVTecDataset):
    ...
    def get_image_data(self):
        ...
        for classname in self.classnames_to_use:
            # H:\lsw\abnormal-detection-of-blades-MMR_0.1022.lsw\LiMR\datasets\AeBAD\classname\train
            ...
            for anomaly in anomaly_types:
                ...
                if self.split == DatasetSplit.TEST and anomaly != "good":
                    # H:\lsw\abnormal-detection-of-blades-MMR_0.1022.lsw\LiMR\datasets\AeBAD\classname\ground_truth\anomaly\
                    anomaly_mask_path = os.path.join(maskpath, anomaly)
                    temp_imgpaths_per_class = imgpaths_per_class[classname][anomaly]
                    # warning: in some cases, x.split("\\")[-1] is not available instead of x.split("/")[-1]
